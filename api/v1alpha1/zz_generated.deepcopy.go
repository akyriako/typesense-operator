...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypesenseKeyRequest) DeepCopyInto(out *TypesenseKeyRequest) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypesenseKeyRequest.
func (in *TypesenseKeyRequest) DeepCopy() *TypesenseKeyRequest {
	if in == nil {
		return nil
	}
	out := new(TypesenseKeyRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TypesenseKeyRequest) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypesenseKeyRequestList) DeepCopyInto(out *TypesenseKeyRequestList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]TypesenseKeyRequest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypesenseKeyRequestList.
func (in *TypesenseKeyRequestList) DeepCopy() *TypesenseKeyRequestList {
	if in == nil {
		return nil
	}
	out := new(TypesenseKeyRequestList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TypesenseKeyRequestList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypesenseKeyRequestSpec) DeepCopyInto(out *TypesenseKeyRequestSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypesenseKeyRequestSpec.
func (in *TypesenseKeyRequestSpec) DeepCopy() *TypesenseKeyRequestSpec {
	if in == nil {
		return nil
	}
	out := new(TypesenseKeyRequestSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TypesenseKeyRequestStatus) DeepCopyInto(out *TypesenseKeyRequestStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TypesenseKeyRequestStatus.
func (in *TypesenseKeyRequestStatus) DeepCopy() *TypesenseKeyRequestStatus {
	if in == nil {
		return nil
	}
	out := new(TypesenseKeyRequestStatus)
	in.DeepCopyInto(out)
	return out
}
